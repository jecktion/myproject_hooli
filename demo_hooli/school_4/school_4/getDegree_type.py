...
def getDegree_type(degree_type):
    try:
        if "Associate Degree" in degree_type:
            ...
            degree_type = 'MPhys'
        elif "PGDip" in degree_type:
            degree_type = 'PGDip'
        elif "PGDip" in degree_type:
            degree_type = 'PGDip'
        elif "MClinDent" in degree_type:
            degree_type = 'MClinDent'
        elif "MLitt" in degree_type:
            degree_type = 'MLitt'
        elif "MPhil, PhD" in degree_type:
            degree_type = 'MPhil, PhD'
        elif "MPrac" in degree_type:
            degree_type = 'MPrac'
