...
'/journey/web-development-bsc-hons.html']
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=r'/courses/.*'),callback='parse_item',follow=False),
    ...
    def parse_item(self,response):
        ...
        programme_s = response.xpath('//section[@class="pageHead"]/h1/text()').extract()
        ...
        modules = response.xpath('//dd[@class="accordion__content rte"]//text()').extract()
        ...
        career = response.xpath('//*[@id="#content"]/div/div/dl/dd/div//text()').extract()
        career = ''.join(career)
        print(8, career)
        ...
        how_to_apply = response.xpath('//*[@id="#content"]/div/div/dl/dd/div//text()').extract()
        how_to_apply = ''.join(how_to_apply)
        print(11,how_to_apply)

        entry_requirements = response.xpath('//*[@id="#content"]/div/div/dl/dd/div//text()').extract()
