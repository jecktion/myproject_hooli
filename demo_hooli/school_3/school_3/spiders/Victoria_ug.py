...
class PlymouthSpider(CrawlSpider):
    ...
    start_urls = ['https://www.vu.edu.au/courses/search?f%5B0%5D=field_unit_lev%3Aundergrad&page=0']
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=r'https://www.vu.edu.au/courses/search\?f%5B0%5D=field_unit_lev%3Aundergrad&page=[0-6]'),follow=True),
