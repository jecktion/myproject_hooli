...
class PlymouthSpider(CrawlSpider):
    ...
    start_urls = ['https://www.cqu.edu.au/courses/postgraduate']
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=(r'.*'),restrict_xpaths=('//*[@id="new_div_53285"]/li/a')), callback='parse_item',follow=True),
