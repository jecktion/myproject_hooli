...
class PlymouthSpider(scrapy.Spider):
    ...
    Lists = ['degrees/bachelor-of-aboriginal-professional-practice',
    ...
    def parse(self,response):
        ...
        department = response.xpath('//*[@id="section-details"]/table[@class="details-table"]/tbody/tr[12]/td/ol/li/a/text()').extract()
        ...
        mode = response.xpath('//*[@id="panel"]/div[@class="fast-facts ff-in-header fast-facts-ug"]/div[@class="inner"]/div[@class="fast-facts-content"]/div[@class="fast-fact-items" and @data-region="international"]/div[@class="flex-inner"][3]/div[@class="fast-fact-item"][2]/p/text() | //*[@id="section-details"]/table/tbody/tr[6]/td/ul[@class="unstyled-list"]/li[2]//text()').extract()
        mode = ' '.join(mode)
        item["mode"] = mode
        print('mode:',mode)

        duration = response.xpath('//*[@id="panel"]/div[@class="fast-facts ff-in-header fast-facts-ug"]/div[@class="inner"]/div[@class="fast-facts-content"]/div[@class="fast-fact-items" and @data-region="international"]/div[@class="flex-inner"][3]/div[@class="fast-fact-item"][1]/p/text()').extract()
        duration = ''.join(duration)
        item["duration"] = duration
        print('duration:',duration)

        # career = response.xpath('').extract()
        # career = ''.join(career)
        # item["career"] = career
        # print('career:',career)

        tuition_fee_link = response.xpath('//*[@id="panel"]/div[@class="fast-facts ff-in-header fast-facts-ug"]/div[@class="inner"]/div[@class="fast-facts-content"]/div[@class="fast-fact-items" and @data-region="international"]/div[@class="flex-inner"][2]/div[@class="fast-fact-item"][1]/p/a/@href').extract()
        ...
        location = response.xpath('//*[@id="panel"]/div[@class="fast-facts ff-in-header fast-facts-ug"]/div[@class="inner"]/div[@class="fast-facts-content"]/div[@class="fast-fact-items" and @data-region="international"]/div[@class="flex-inner"][1]/div[@class="fast-fact-item"][1]/p/a/text() | //*[@id="section-details"]/table/tbody/tr[4]/td/ul[@class="unstyled-list"]//text()').extract()
        location = ''.join(location)
        item["location"] = location
        print('location:',location)

        IELTS = response.xpath('//*[@id="panel"]/div[@class="fast-facts ff-in-header fast-facts-ug"]/div[@class="inner"]/div[@class="fast-facts-content"]/div[@class="fast-fact-items" and @data-region="international"]/div[@class="flex-inner"][2]/div[@class="fast-fact-item"][2]/ul/li/text()').extract()
        IELTS = ''.join(IELTS)
        item["IELTS"] = IELTS
        print('IELTS:',IELTS)
        ...
        entry_requirements = response.xpath('//*[@data-region="international"]//div[@class="uon-accordion-content"]//text() | //*[@id="section-admission-information"]//text()').extract()
        ...
        overview = response.xpath('//*[@id="degree-details"]/p/text() | //*[@id="degree-details"]/ul/li//text()').extract()
